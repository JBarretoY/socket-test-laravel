...
<body class="home page-template page-template-page-home-new page-template-page-home-new-php page page-id-9 two-column right-sidebar">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    @if(auth()->check())
                        <li class="nav-item d-md-none d-lg-none">
                            <a class="nav-link dropdown-toggle d-flex align-items-center justify-content-start" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="" alt="" style="background: red; height: 30px; width: 30px; border-radius: 50%; margin-right: 5px;">
                        ...
                        <li class="nav-link d-md-none d-lg-none">
                            <a class="nav-link" href="http://betatest.consultaneo.com/mensajes/">BANDEJA DE ENTRADA</a>
                        </li>
                    @endif
                    <li class="nav-item active">
                        <div class="fre-search-wrap">
                            <form class="fre-form-search" action="http://betatest.consultaneo.com/profiles/" method="post" style="padding: 0 10px;">
                                <div class="fre-search dropdown" style="padding: 0 10px;">
                                    ...
                                    <ul class="dropdown-menu fre-search-dropdown">
                                        <li><a class="active" data-type="profile" data-action="http://betatest.consultaneo.com/profiles/">Buscar Consultores</a>
                                        </li>
                                        <li><a class="" data-type="project" data-action="http://betatest.consultaneo.com/projects/">Buscar Proyectos</a>
                                        </li>
                                    </ul>
                                </div>
                            </form>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">MI PROYECTO</a>
                    </li>
                    <li class="nav-item">
                    ...
                    @if(auth()->check())
                        ...
                        <li class="nav-item dropdown d-xs-none d-sm-none d-md-block d-lg-block">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="http://betatest.consultaneo.com/mensajes/">Bandeja de Entrada</a>
    ...
    {{-- <div class="fre-account-wrap dropdown">
        ...
        <ul class="list_notify dropdown-menu dropdown-menu-notifi dropdown-keep-open notification-list">
            <li style="text-align: center;">
                <a class="view-more-notify" href="http://betatest.consultaneo.com/list-notification/">
    ...
    @yield('content')
    <footer class="copyright-wrapper footer-copyright-wrapper mt-3">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4 col-lg-3 mt-4">
                    ...
                    <div class="mt-3">
                        <a class="fre-btn primary-bg-color" style="border-radius: 10px; padding: 5px 10px; height: unset; line-height: unset;" href="#">Recibe consultoría</a>
                    </div>
